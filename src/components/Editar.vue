  ...
  <div class="col-sm-8 main-section">
    <div class="modal-content">
      <div class="col-12 user-img">
        <img src="https://icon-library.net/images/change-icon-png/change-icon-png-19.jpg" width="200" height="197">
      </div>
      <form class="col-12">
        <h2 style="color:white"> Editar alumno </h2>
      ...
      <option v-for="carrera in carreras" v-bind:key="carrera" v-bind:value="carrera.id">{{carrera.nombre}}</option>
        ...
        <button type="button" class="btn" @click="actualizar"><i class="fas fa-sign-in-alt">     Entrar</i> </button>
        </div>
      </form> 
    ...
    data() {
     ...
     methods: {
       actualizar(){
          ...
          API.put('http://isuri.ddns.net/adminUp/v1/alumnos/'+ this.id ,
        {
          nombre: this.nombre,
